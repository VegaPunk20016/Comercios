...
class DomicilioController extends ResourceController
{
    ...
    public function index()
    {
        ...
        try {
            ...
            return $this->failServerError('Ocurrió un error al obtener los registros de Domicilio');
        }
    }
    ...
    public function show($id = null)
    {
        ...
        try {
            ...
            log_message('error', 'Error en DomicilioController::show: ' . $e->getMessage());
            return $this->failServerError('Ocurrió un error al obtener la solicitud al recurso de Domicilio');
        }
    }
}
